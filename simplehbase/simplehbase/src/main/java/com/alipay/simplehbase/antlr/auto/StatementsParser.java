...
public class StatementsParser extends Parser {
    ...
    public static final int                       T__2                = 1,
            T__1 = 2, T__0 = 3, STAR = 4, LB = 5, RB = 6, WHERE = 7,
            SELECT = 8, COUNT = 9, INSERT = 10, DELETE = 11, INTO = 12,
            VALUES = 13, FROM = 14, ROWKEY = 15, STARTKEY = 16, ENDKEY = 17,
            HBASESTARTKEY = 18, HBASEENDKEY = 19, MAXVERSION = 20, LIMIT = 21,
            TS = 22, STARTTS = 23, ENDTS = 24, IS = 25, NULL = 26, NOT = 27,
            AND = 28, OR = 29, LESSEQUAL = 30, LESS = 31, GREATEREQUAL = 32,
            GREATER = 33, NOTEQUAL = 34, EQUAL = 35, NOTMATCH = 36, MATCH = 37,
            IN = 38, NOTIN = 39, BETWEEN = 40, NOTBETWEEN = 41, ISNULL = 42,
            ISNOTNULL = 43, ISMISSING = 44, ISNOTMISSING = 45, TEXT = 46,
            WS = 47;
    public static final String[]                  tokenNames          = {
            "<INVALID>", "','", "'#'", "'\"'", "'*'", "'('", "')'", "'where'",
            "'select'", "'count'", "'insert'", "'delete'", "'into'",
            "'values'", "'from'", "'rowkey'", "'startkey'", "'endkey'",
            "'hbasestartkey'", "'hbaseendkey'", "'maxversion'", "'limit'",
            "'ts'", "'startTS'", "'endTS'", "'is'", "'null'", "'not'", "'and'",
            "'or'", "'lessequal'", "'less'", "'greaterequal'", "'greater'",
            "'notequal'", "'equal'", "'notmatch'", "'match'", "'in'",
            "'notin'", "'between'", "'notbetween'", "'isnull'", "'isnotnull'",
            "'ismissing'", "'isnotmissing'", "TEXT", "WS"            };
    public static final int                       RULE_prog           = 0,
            RULE_inserthqlc = 1, RULE_selecthqlc = 2, RULE_deletehqlc = 3,
            RULE_selectc = 4, RULE_countc = 5, RULE_wherec = 6,
            RULE_conditionc = 7, RULE_rowkeyrange = 8, RULE_rowkeyexp = 9,
            RULE_tsrange = 10, RULE_tsexp = 11, RULE_selectCidList = 12,
            RULE_cidList = 13, RULE_cid = 14, RULE_funcname = 15,
            RULE_constantList = 16, RULE_constant2List = 17,
            RULE_constant2 = 18, RULE_maxversionexp = 19, RULE_limitexp = 20,
            RULE_tablename = 21, RULE_maxversion = 22, RULE_constant = 23,
            RULE_var = 24;
    public static final String[]                  ruleNames           = {
            "prog", "inserthqlc", "selecthqlc", "deletehqlc", "selectc",
            "countc", "wherec", "conditionc", "rowkeyrange", "rowkeyexp",
            "tsrange", "tsexp", "selectCidList", "cidList", "cid", "funcname",
            "constantList", "constant2List", "constant2", "maxversionexp",
    ...
    public static class SelectclContext extends ProgContext {
        ...
        public SelectclContext(ProgContext ctx) {
            copyFrom(ctx);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof StatementsVisitor)
                return ((StatementsVisitor<? extends T>) visitor)
                        .visitSelectcl(this);
            else
    ...
    public static class InsertHqlClContext extends ProgContext {
        ...
        public InsertHqlClContext(ProgContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class DeleteHqlClContext extends ProgContext {
        ...
        public DeleteHqlClContext(ProgContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class CountclContext extends ProgContext {
        ...
        public CountclContext(ProgContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class SelectHqlClContext extends ProgContext {
        ...
        public SelectHqlClContext(ProgContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class InserthqlcContext extends ParserRuleContext {
        ...
        public TerminalNode ROWKEY() {
            return getToken(StatementsParser.ROWKEY, 0);
        }
        ...
        public TerminalNode INSERT() {
            return getToken(StatementsParser.INSERT, 0);
        }

        public List<TerminalNode> IS() {
            return getTokens(StatementsParser.IS);
        }

        public TerminalNode INTO() {
            return getToken(StatementsParser.INTO, 0);
        }

        public TerminalNode TS() {
            return getToken(StatementsParser.TS, 0);
        }

        public TerminalNode VALUES() {
            return getToken(StatementsParser.VALUES, 0);
        }
    ...
    public static class SelecthqlcContext extends ParserRuleContext {
        ...
        public TerminalNode FROM() {
            return getToken(StatementsParser.FROM, 0);
        }
        ...
        public TerminalNode SELECT() {
            return getToken(StatementsParser.SELECT, 0);
        }
    ...
    public static class DeletehqlcContext extends ParserRuleContext {
        ...
        public TerminalNode DELETE() {
            return getToken(StatementsParser.DELETE, 0);
        }
        ...
        public TerminalNode IS() {
            return getToken(StatementsParser.IS, 0);
        }
    ...
    public static class CountcContext extends ParserRuleContext {
        ...
        public TerminalNode COUNT() {
            return getToken(StatementsParser.COUNT, 0);
        }
    ...
    public static class WherecContext extends ParserRuleContext {
        ...
        public TerminalNode WHERE() {
            return getToken(StatementsParser.WHERE, 0);
        }
    ...
    public static class NotmatchconstantContext extends ConditioncContext {
        ...
        public TerminalNode NOTMATCH() {
            return getToken(StatementsParser.NOTMATCH, 0);
        }
        ...
        public NotmatchconstantContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NotbetweenconstantContext extends ConditioncContext {
        ...
        public TerminalNode AND() {
            return getToken(StatementsParser.AND, 0);
        }

        public TerminalNode NOTBETWEEN() {
            return getToken(StatementsParser.NOTBETWEEN, 0);
        }
        ...
        public NotbetweenconstantContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NotmatchvarContext extends ConditioncContext {
        ...
        public NotmatchvarContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class EqualvarContext extends ConditioncContext {
        ...
        public TerminalNode EQUAL() {
            return getToken(StatementsParser.EQUAL, 0);
        }
        ...
        public EqualvarContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class IsnotmissingcContext extends ConditioncContext {
        public TerminalNode ISNOTMISSING() {
            return getToken(StatementsParser.ISNOTMISSING, 0);
        }
        ...
        public IsnotmissingcContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NotinconstantlistContext extends ConditioncContext {
        ...
        public TerminalNode NOTIN() {
            return getToken(StatementsParser.NOTIN, 0);
        }

        public NotinconstantlistContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class BetweenvarContext extends ConditioncContext {
        ...
        public TerminalNode BETWEEN() {
            return getToken(StatementsParser.BETWEEN, 0);
        }
        ...
        public BetweenvarContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class IsnotnullcContext extends ConditioncContext {
        public TerminalNode ISNOTNULL() {
            return getToken(StatementsParser.ISNOTNULL, 0);
        }
        ...
        public IsnotnullcContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class LessconstantContext extends ConditioncContext {
        ...
        public TerminalNode LESS() {
            return getToken(StatementsParser.LESS, 0);
        }

        public LessconstantContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class IsmissingcContext extends ConditioncContext {
        public TerminalNode ISMISSING() {
            return getToken(StatementsParser.ISMISSING, 0);
        }
        ...
        public IsmissingcContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class IsnullcContext extends ConditioncContext {
        ...
        public TerminalNode ISNULL() {
            return getToken(StatementsParser.ISNULL, 0);
        }

        public IsnullcContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class ConditionwrapperContext extends ConditioncContext {
        ...
        public TerminalNode LB() {
            return getToken(StatementsParser.LB, 0);
        }

        public TerminalNode RB() {
            return getToken(StatementsParser.RB, 0);
        }

        public ConditionwrapperContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class GreaterconstantContext extends ConditioncContext {
        ...
        public TerminalNode GREATER() {
            return getToken(StatementsParser.GREATER, 0);
        }
        ...
        public GreaterconstantContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class EqualconstantContext extends ConditioncContext {
        ...
        public EqualconstantContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class GreatervarContext extends ConditioncContext {
        ...
        public GreatervarContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class MatchvarContext extends ConditioncContext {
        public TerminalNode MATCH() {
            return getToken(StatementsParser.MATCH, 0);
        }
        ...
        public MatchvarContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class GreaterequalvarContext extends ConditioncContext {
        public TerminalNode GREATEREQUAL() {
            return getToken(StatementsParser.GREATEREQUAL, 0);
        }
        ...
        public GreaterequalvarContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NotbetweenvarContext extends ConditioncContext {
        ...
        public NotbetweenvarContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class OrconditionContext extends ConditioncContext {
        ...
        public TerminalNode OR() {
            return getToken(StatementsParser.OR, 0);
        }

        public OrconditionContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class GreaterequalconstantContext extends ConditioncContext {
        ...
        public GreaterequalconstantContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof StatementsVisitor)
                return ((StatementsVisitor<? extends T>) visitor)
                        .visitGreaterequalconstant(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class InvarlistContext extends ConditioncContext {
        public TerminalNode IN() {
            return getToken(StatementsParser.IN, 0);
        }
        ...
        public InvarlistContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class AndconditionContext extends ConditioncContext {
        ...
        public AndconditionContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NotequalconstantContext extends ConditioncContext {
        ...
        public TerminalNode NOTEQUAL() {
            return getToken(StatementsParser.NOTEQUAL, 0);
        }

        public NotequalconstantContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class LessequalvarContext extends ConditioncContext {
        ...
        public TerminalNode LESSEQUAL() {
            return getToken(StatementsParser.LESSEQUAL, 0);
        }
        ...
        public LessequalvarContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class BetweenconstantContext extends ConditioncContext {
        ...
        public BetweenconstantContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class LessvarContext extends ConditioncContext {
        ...
        public LessvarContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class LessequalconstantContext extends ConditioncContext {
        ...
        public LessequalconstantContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NotinvarlistContext extends ConditioncContext {
        ...
        public NotinvarlistContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class InconstantlistContext extends ConditioncContext {
        ...
        public InconstantlistContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class MatchconstantContext extends ConditioncContext {
        ...
        public MatchconstantContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class NotequalvarContext extends ConditioncContext {
        ...
        public NotequalvarContext(ConditioncContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof StatementsVisitor)
                return ((StatementsVisitor<? extends T>) visitor)
                        .visitNotequalvar(this);
            else
                return visitor.visitChildren(this);
        }
    }

    public final ConditioncContext conditionc(int _p)
                    ...
                    if (_alt == 1) {
                        ...
                        _prevctx = _localctx;
                        {
                            ...
                            switch (getInterpreter().adaptivePredict(_input, 9,
                                    _ctx)) {
                                case 1: {
                                    _localctx = new AndconditionContext(
                                            new ConditioncContext(_parentctx,
                                                    _parentState, _p));
                                    pushNewRecursionContext(_localctx,
                                            _startState, RULE_conditionc);
                                    setState(233);
                                    if (!(30 >= _localctx._p))
                                ...
                                case 2: {
                                    _localctx = new OrconditionContext(
                                            new ConditioncContext(_parentctx,
                                                    _parentState, _p));
                                    pushNewRecursionContext(_localctx,
                                            _startState, RULE_conditionc);
    ...
    public static class Rowkeyrange_startAndEndContext extends
            RowkeyrangeContext {
        public TerminalNode STARTKEY() {
            return getToken(StatementsParser.STARTKEY, 0);
        }
        ...
        public TerminalNode ENDKEY() {
            return getToken(StatementsParser.ENDKEY, 0);
        }
        ...
        public Rowkeyrange_startAndEndContext(RowkeyrangeContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof StatementsVisitor)
                return ((StatementsVisitor<? extends T>) visitor)
                        .visitRowkeyrange_startAndEnd(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class Rowkeyrange_endContext extends RowkeyrangeContext {
        ...
        public Rowkeyrange_endContext(RowkeyrangeContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class Rowkeyrange_startContext extends RowkeyrangeContext {
        ...
        public Rowkeyrange_startContext(RowkeyrangeContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class Rowkey_FuncConstantContext extends RowkeyexpContext {
        ...
        public Rowkey_FuncConstantContext(RowkeyexpContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class Rowkey_hbasestartContext extends RowkeyexpContext {
        public TerminalNode HBASESTARTKEY() {
            return getToken(StatementsParser.HBASESTARTKEY, 0);
        }

        public Rowkey_hbasestartContext(RowkeyexpContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class Rowkey_hbaseendContext extends RowkeyexpContext {
        public TerminalNode HBASEENDKEY() {
            return getToken(StatementsParser.HBASEENDKEY, 0);
        }

        public Rowkey_hbaseendContext(RowkeyexpContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class Rowkey_WrapperContext extends RowkeyexpContext {
        ...
        public Rowkey_WrapperContext(RowkeyexpContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class Tsrange_startContext extends TsrangeContext {
        ...
        public TerminalNode STARTTS() {
            return getToken(StatementsParser.STARTTS, 0);
        }
        ...
        public Tsrange_startContext(TsrangeContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class Tsrange_endContext extends TsrangeContext {
        ...
        public TerminalNode ENDTS() {
            return getToken(StatementsParser.ENDTS, 0);
        }

        public Tsrange_endContext(TsrangeContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class Tsrange_startAndEndContext extends TsrangeContext {
        ...
        public Tsrange_startAndEndContext(TsrangeContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class CidList_CidListContext extends SelectCidListContext {
        ...
        public CidList_CidListContext(SelectCidListContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class CidList_RegxContext extends SelectCidListContext {
        public TerminalNode TEXT() {
            return getToken(StatementsParser.TEXT, 0);
        }

        public CidList_RegxContext(SelectCidListContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class CidList_StarContext extends SelectCidListContext {
        public TerminalNode STAR() {
            return getToken(StatementsParser.STAR, 0);
        }

        public CidList_StarContext(SelectCidListContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof StatementsVisitor)
                return ((StatementsVisitor<? extends T>) visitor)
                        .visitCidList_Star(this);
            else
                return visitor.visitChildren(this);
        }
    }

    public final SelectCidListContext selectCidList()
            throws RecognitionException {
        SelectCidListContext _localctx = new SelectCidListContext(_ctx,
                getState());
    ...
    public final ConstantListContext constantList() throws RecognitionException {
        ConstantListContext _localctx = new ConstantListContext(_ctx,
                getState());
    ...
    public static class Constant2ListContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof StatementsVisitor)
                return ((StatementsVisitor<? extends T>) visitor)
                        .visitConstant2List(this);
            else
                return visitor.visitChildren(this);
        }
    }

    public final Constant2ListContext constant2List()
            throws RecognitionException {
        Constant2ListContext _localctx = new Constant2ListContext(_ctx,
                getState());
    ...
    public static class Constant2_NotNullContext extends Constant2Context {
        ...
        public Constant2_NotNullContext(Constant2Context ctx) {
            copyFrom(ctx);
        }
    ...
    public static class Constant2_NullContext extends Constant2Context {
        public TerminalNode NULL() {
            return getToken(StatementsParser.NULL, 0);
        }

        public Constant2_NullContext(Constant2Context ctx) {
            copyFrom(ctx);
        }
    ...
    public static class MaxversionexpContext extends ParserRuleContext {
        ...
        public TerminalNode MAXVERSION() {
            return getToken(StatementsParser.MAXVERSION, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof StatementsVisitor)
                return ((StatementsVisitor<? extends T>) visitor)
                        .visitMaxversionexp(this);
            else
                return visitor.visitChildren(this);
        }
    }

    public final MaxversionexpContext maxversionexp()
            throws RecognitionException {
        MaxversionexpContext _localctx = new MaxversionexpContext(_ctx,
                getState());
    ...
    public static class LimitexpContext extends ParserRuleContext {
        ...
        public List<TerminalNode> TEXT() {
            return getTokens(StatementsParser.TEXT);
        }

        public TerminalNode LIMIT() {
            return getToken(StatementsParser.LIMIT, 0);
        }
    ...
    public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
        switch (ruleIndex) {
            case 7:
                return conditionc_sempred((ConditioncContext) _localctx,
                        predIndex);
        }
        return true;
    }

    private boolean conditionc_sempred(ConditioncContext _localctx,
            int predIndex) {
        switch (predIndex) {
            case 0:
                return 30 >= _localctx._p;
    ...
    public static final String _serializedATN = "\2\3\61\u0169\4\2\t\2\4\3\t\3\4\4\t\4\4\5\t\5\4\6\t\6\4\7\t\7\4\b\t\b"
                                                      + "\4\t\t\t\4\n\t\n\4\13\t\13\4\f\t\f\4\r\t\r\4\16\t\16\4\17\t\17\4\20\t"
                                                      + "\20\4\21\t\21\4\22\t\22\4\23\t\23\4\24\t\24\4\25\t\25\4\26\t\26\4\27\t"
                                                      + "\27\4\30\t\30\4\31\t\31\4\32\t\32\3\2\3\2\3\2\3\2\3\2\5\2:\n\2\3\3\3\3"
                                                      + "\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\5\3H\n\3\3\4\3\4\3\4\3\4\3\4"
                                                      + "\5\4O\n\4\3\4\3\4\5\4S\n\4\3\4\5\4V\n\4\3\4\5\4Y\n\4\3\5\3\5\3\5\3\5\3"
                                                      ...
                                                      + "\u00ea\n\t\3\t\3\t\3\t\3\t\3\t\3\t\7\t\u00f2\n\t\f\t\16\t\u00f5\13\t\3"
                                                      + "\n\3\n\3\n\3\n\3\n\3\n\3\n\3\n\3\n\3\n\3\n\3\n\3\n\3\n\5\n\u0105\n\n\3"
                                                      + "\13\3\13\3\13\3\13\3\13\3\13\3\13\3\13\3\13\3\13\3\13\5\13\u0112\n\13"
                                                      + "\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\3\f\5\f\u0122\n\f"
                                                      + "\3\r\3\r\3\16\3\16\3\16\5\16\u0129\n\16\3\17\3\17\3\17\3\17\7\17\u012f"
                                                      + "\n\17\f\17\16\17\u0132\13\17\3\17\3\17\3\20\3\20\3\21\3\21\3\22\3\22\3"
                                                      + "\22\3\22\7\22\u013e\n\22\f\22\16\22\u0141\13\22\3\22\3\22\3\23\3\23\3"
                                                      + "\23\3\23\7\23\u0149\n\23\f\23\16\23\u014c\13\23\3\23\3\23\3\24\3\24\5"
                                                      + "\24\u0152\n\24\3\25\3\25\3\25\3\26\3\26\3\26\3\26\5\26\u015b\n\26\3\27"
                                                      + "\3\27\3\30\3\30\3\31\3\31\3\31\3\31\3\32\3\32\3\32\3\32\3\32\2\33\2\4"
                                                      + "\6\b\n\f\16\20\22\24\26\30\32\34\36 \"$&(*,.\60\62