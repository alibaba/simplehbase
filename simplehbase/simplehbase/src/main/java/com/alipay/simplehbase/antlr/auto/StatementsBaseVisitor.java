...
public class StatementsBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements StatementsVisitor<T> {
	...
	@Override public T visitTsrange(StatementsParser.TsrangeContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitRowkey_End(StatementsParser.Rowkey_EndContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitRowkeyrange(StatementsParser.RowkeyrangeContext ctx) { return visitChildren(ctx); }
