 ...
 * @author xinzhi
 */
public class TestDeleteList extends MyRecordTestBase {
	...
	public void deleteObjectList() {
		...
		simpleHbaseClient.deleteList(rowkeyList);
	...
	public void deleteObjectList2() {
		...
		simpleHbaseClient.deleteList(myRecordRowKey1, myRecordRowKey2);
		...
		simpleHbaseClient.deleteList(myRecordRowKey2, myRecordRowKey3);
